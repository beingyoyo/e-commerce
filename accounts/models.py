...
class MyAccountManager(AbstractBaseUser):
    def create_user(self, first_name, last_name, username, email, password = None):
        ...
        user = self.model(
            email = self.normalize_email(email), #normalize the e-mail, if caps entered, will be noramlized to smallcase
            username = username,
...
class Account(AbstractBaseUser):
    ...
    #Login with email setting
    USERNAME_FIELD = 'email'
    REQUIRED_FIELD = ['username', 'firstname', 'lastname']
