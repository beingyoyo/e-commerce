...
def payments(request):
    ...
    #Send order number and trans ID back to sendData method via JsonResponse
...
def place_order(request, total = 0, quantity = 0):
    ...
    #If cart count <= 0, then redirect to store
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime("%Y%m%d") #20220130
